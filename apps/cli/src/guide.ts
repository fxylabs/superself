...
export const TOPICS: Topic[] = [
    {
        ...
        body: [
            ...
            "",
            "       self work propose \"<plan>\"             # a person accepts it",
            "       self work start <id>",
            "       self report <id> \"<what happened>\"      # after committing",
            "",
            "     The outcome is what must become true, not the task. A session proposes",
            "     it: `work add` records a confirmed unit and is a person's own command,",
            "     refused where no person is at the terminal. `start` is how a",
    ...
    },
    {
        ...
        body: [
            ...
            "",
            "All three need a person at a terminal, and a cleanup produces a dozen of",
            "them at once. Write them to a file, one per line, and approve the set",
            "with one action:",
            "",
            "  self apply <file>",
            "",
    ...
    },
    {
        ...
        body: [
            ...
            "",
            "  self work propose \"<plan>\"                 recorded as work waiting on a person",
            "  self work revise <id> \"<revised plan>\" --why \"<what changed>\"",
            "",
            "This is not a habit but the rule: `work add` and `work accept` write a",
            "confirmed record, so a session running either is refused and handed the",
            "propose line. The person accepts with `self work accept <id>` at their own",
            "terminal.",
            "",
            ...
            "acceptance, so `self work start` is refused until the user accepts again.",
            ...
            "",
            "The named unit is untouched until the acceptance, which records the new",
