...
import { evidenceHashes, updateVerdicts, Verdict, verdictSignals } from "./reachability.js";
...
export function foldProject(storeDir: string, slug: string): void
{
    ...
    const verdicts = updateVerdicts(storeDir, slug, projectDir, evidenceHashes(model.works));
