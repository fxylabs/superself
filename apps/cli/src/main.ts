...
const USAGE = `usage: self <command>
  ...
  report <work-id> "<summary>" [--file path] [--evidence v] [--artifact path] [--next n]
                                             (--evidence: a revision this repo resolves, else a note;
                                              force either with commit:<v> or note:<v>)
