...
export const COMMANDS: Command[] = [
    ...
    },
    {
        ...
        usage: [
            ...
            {
                syntax: 'work revise <id> "<revised plan>" --why w [--objective <id>|--milestone <id>]',
                description: [
