...
import { artifactSignals, stageArtifacts } from "../dist/artifact.js";
...
{
    return artifactSignals(store, [{ id: artifact.id, status: "doing", artifacts: [artifact.meta] }]);
}
...
// what digestOf did before it was guarded, byte for byte
